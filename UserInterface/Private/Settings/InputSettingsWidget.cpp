...
void UInputSettingsWidget::InitializeInputSettings(const TMap<FName, FKeyMappingRow>& InPlayerMappedRows)
{
...
void UInputSettingsWidget::OnIsSelectingKey(UInputKeySelector* KeySelector)
{
...
FReply UInputSettingsWidget::NativeOnMouseWheel(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent)
{
	// Lame workaround to allow Mouse Wheel Up and Mouse Wheel Down for InputKeySelectors
...
void UInputSettingsWidget::OnSliderTextBoxValueChanged(USingleRangeInputWidget* Widget, const float Value)
{
...
void UInputSettingsWidget::OnButtonClicked_BSButton(const UBSButton* Button)
{
...
void UInputSettingsWidget::OnButtonClicked_Save()
{
...
void UInputSettingsWidget::OnButtonClicked_Reset()
{
	UEnhancedInputLocalPlayerSubsystem* Subsystem = ULocalPlayer::GetSubsystem<UEnhancedInputLocalPlayerSubsystem>(
		GetOwningPlayer()->GetLocalPlayer());
...
void UInputSettingsWidget::OnButtonClicked_Revert()
{
