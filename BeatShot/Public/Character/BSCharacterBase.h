...
protected:
	...
	/** Default inventory items. Each entry should contain an inventory item definition composed of inventory
	 *  fragments. */
...
protected:
	/** Grant abilities on the Server. The Ability Specs will be replicated to the owning client. Called from
	 *  inside PossessedBy(). */
	...
	/** Removes all CharacterAbilities. Can only be called by the Server. Removing on the Server will remove from
	 *  Client too. */
