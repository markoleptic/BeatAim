...
public:
	...
	/**
	 * If a BSCharacter is the found on the OwningAbility, a Line Trace is performed starting at the Recoil Component's
	 * transform. Traces forward by TraceDistance.
